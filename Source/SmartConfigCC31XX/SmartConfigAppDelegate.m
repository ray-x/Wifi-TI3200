...
#import "SmartConfigAppDelegate.h"
#import "ZBarSDK.h"
#import "SmartConfigGlobalConfig.h"

@implementation SmartConfigAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _window.tintColor = [UIColor colorWithRed:204 green:0 blue:0 alpha:1];
    ...
    globalConfig.launchTime = [NSDate date];
